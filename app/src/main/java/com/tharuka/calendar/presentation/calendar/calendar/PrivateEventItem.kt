    ...
    Box(modifier = modifier) {
        Row(
            ...
            Box(
                modifier = Modifier
                    .size(48.dp)
                    .background(shape = CircleShape, color = MaterialTheme.colors.onSecondary),
            ...
            Column(verticalArrangement = Arrangement.Center) {
                ...
                Text(
                    text = "${event.day}/ ${event.month}/ ${event.year}  from ${event.startTime} to ${event.endTime?:""}:"
